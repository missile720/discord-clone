    ...
    <div className="login-container">
      <div className="login-left">
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          <label className="login-formText">
            email or phone number <span className="login-asterisk">*</span>
          </label>
      ...
      <div className="login-right">
        <img className="login-qr" src="/images/qrcode_linkedIn.png" alt="" />
        <h2 className="login-qr-header">Log in with QR Code</h2>
        <p className="login-qr-subText">
